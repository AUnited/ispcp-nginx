...
open (CFG,"/etc/ispcp/ispcp.conf") || die "Can't open ispcp configuration file /etc/ispcp/ispcp.conf!: $! ";
while (<CFG>) {
chomp;
...
# Written by Nikolay Yatsyshyn (koffua\@gmail.com) for ispcp project.
